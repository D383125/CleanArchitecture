...
const SupportChat = () => {
  ...
  const [selectedChatSummary, setSelectedChatSummary] =
    useState<ChatSummary | null>();
  ...
  useEffect(() => console.log(`IS Form dirty ${isDirty}`), [isDirty]);
      ...
      (chunk) => {
        ...
        setCurrentMessage((prev) => {
          const assistantMessage = prev.find(
            (msg) => msg.role === "assistant" && msg.id === prev.length,
          );
          if (assistantMessage) {
  ...
  return (
    ...
    >
      ...
      >
        ...
        isSmallScreen 
        ? 
        <p>Mobile is Under Construction</p>
        : 
                    ...
                    chatSummaries.map((chat) => (
                      <React.Fragment key={chat.id}>
                        <ListItemButton
                          ...
                          sx={muiStyles.listItemButton(
                            selectedChatSummary?.id === chat.id,
                          )}
                        >
                          <ListItemAvatar>
